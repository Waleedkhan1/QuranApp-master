...
package com.quranapp.islamic.frags.settings;
...
import static com.quranapp.islamic.reader_managers.ReaderParams.READER_STYLE_PAGE;
import static com.quranapp.islamic.reader_managers.ReaderParams.READER_STYLE_TRANSLATION;
import static com.quranapp.islamic.utils.app.DownloadSourceUtils.DOWNLOAD_SRC_DEFAULT;
import static com.quranapp.islamic.utils.app.DownloadSourceUtils.DOWNLOAD_SRC_GITHUB;
import static com.quranapp.islamic.utils.app.DownloadSourceUtils.DOWNLOAD_SRC_JSDELIVR;
import static com.quranapp.islamic.utils.reader.ReaderTextSizeUtils.TEXT_SIZE_MIN_PROGRESS;
import static com.quranapp.islamic.utils.reader.ReaderTextSizeUtils.getMaxProgress;
import static com.quranapp.islamic.utils.univ.Codes.SETTINGS_LAUNCHER_RESULT_CODE;
import static com.quranapp.islamic.utils.univ.Keys.READER_KEY_SAVE_TRANSL_CHANGES;
import static com.quranapp.islamic.utils.univ.Keys.READER_KEY_SETTING_IS_FROM_READER;
import static com.quranapp.islamic.utils.univ.Keys.READER_KEY_TRANSL_SLUGS;
...
import com.quranapp.islamic.activities.readerSettings.ActivitySettings;
import com.quranapp.islamic.api.models.recitation.RecitationInfoModel;
import com.quranapp.islamic.api.models.recitation.RecitationTranslationInfoModel;
import com.quranapp.islamic.api.models.tafsir.TafsirInfoModel;
import com.quranapp.islamic.databinding.FragSettingsMainBinding;
import com.quranapp.islamic.databinding.LytReaderIndexTabBinding;
import com.quranapp.islamic.databinding.LytReaderSettingsItemBinding;
import com.quranapp.islamic.databinding.LytReaderSettingsItemSwitchBinding;
import com.quranapp.islamic.databinding.LytReaderSettingsTextDecoratorBinding;
import com.quranapp.islamic.databinding.LytReaderSettingsTextSizeBinding;
import com.quranapp.islamic.databinding.LytResDownloadSourceSheetBinding;
import com.quranapp.islamic.databinding.LytSettingsLayoutStyleBinding;
import com.quranapp.islamic.databinding.LytSettingsReaderBinding;
import com.quranapp.islamic.databinding.LytSettingsVotdToggleBinding;
import com.quranapp.islamic.databinding.LytThemeExplorerBinding;
import com.quranapp.islamic.frags.settings.appLogs.FragSettingsAppLogs;
import com.quranapp.islamic.frags.settings.recitations.FragSettingsRecitations;
import com.quranapp.islamic.frags.settings.recitations.manage.FragSettingsManageAudio;
import com.quranapp.islamic.reader_managers.ReaderVerseDecorator;
import com.quranapp.islamic.utils.app.DownloadSourceUtils;
import com.quranapp.islamic.utils.app.ThemeUtils;
import com.quranapp.islamic.utils.extensions.ContextKt;
import com.quranapp.islamic.utils.extensions.LayoutParamsKt;
...
import com.quranapp.islamic.utils.reader.QuranScriptUtilsKt;
import com.quranapp.islamic.utils.reader.ReaderTextSizeUtils;
...
import com.quranapp.islamic.utils.reader.recitation.RecitationUtils;
import com.quranapp.islamic.utils.reader.tafsir.TafsirManager;
import com.quranapp.islamic.utils.sharedPrefs.SPAppConfigs;
import com.quranapp.islamic.utils.sharedPrefs.SPReader;
import com.quranapp.islamic.utils.sharedPrefs.SPVerses;
import com.quranapp.islamic.utils.simplified.SimpleSeekbarChangeListener;
import com.quranapp.islamic.utils.simplified.SimpleTabSelectorListener;
import com.quranapp.islamic.utils.tafsir.TafsirUtils;
import com.quranapp.islamic.utils.univ.Keys;
import com.quranapp.islamic.utils.votd.VOTDUtils;
...
import com.quranapp.islamic.widgets.bottomSheet.PeaceBottomSheetParams;
...
public class FragSettingsMain extends FragSettingsBase implements FragmentResultListener {
    ...
    private void initManageAudioExplorer(LinearLayout parent) {
        com.quranapp.islamic.databinding.LytReaderSettingsItemBinding mManageAudioExplorerBinding = LytReaderSettingsItemBinding.inflate(
            mInflater);
